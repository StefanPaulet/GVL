...
public interface VerticesDrawer < VertexLabelType extends Comparable < VertexLabelType >, EdgeType extends Edge < VertexLabelType > > {
    ...
    List < Node > computeVertexLabels ( Graph < VertexLabelType, EdgeType > graph );
}
