...
public class BFSLoader < VertexLabelType extends Comparable < VertexLabelType > , EdgeType extends Edge < VertexLabelType > >
    extends AlgorithmLoader < VertexLabelType, EdgeType > {

    public BFSLoader ( Engine < VertexLabelType, EdgeType > engine ) {
        super( engine );
    }
